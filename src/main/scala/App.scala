...
case class LoanApplicant (loanType: Double, gender: Double, ownCar: Double, ownRealty: Double, income: Double, credit: Double, annuity: Double,
 age: Double, employmentDays: Double, registrationDays: Double, education: Double, familyStatus: Double,
...
object App {
  def main(args: Array[String]): Unit = {
    ...
    val data = sc.textFile("src/application_train.csv")

    val processData = data.flatMap { line =>
    val fields = line.split(",")
    fields match {
      case Array(
            loanType, gender, ownCar, ownRealty, income, credit, annuity, ageDays, employmentDays,
            registrationDays, education, familyStatus, houseType, numChildren, relativePopulation
          ) =>
        Some(LoanApplicant(
          loanType.toDouble,
          ...
          annuity.toDouble,
          ageDays.toDouble,
          employmentDays.toDouble,
          registrationDays.toDouble,
          education match {
